...
CREATE TABLE users (
    ...
    -- Group 1: Rank tracking
    rank_achieved_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    last_sale_at TIMESTAMP,
    consecutive_qualifying_months INTEGER DEFAULT 0,
    highest_rank_level INTEGER DEFAULT 1,
...
CREATE TABLE commissions (
    ...
    type VARCHAR(50) NOT NULL CHECK (type IN ('admin', 'direct', 'difference', 'leadership_bonus', 'team_volume_bonus', 'rank_bonus', 'bonus_pool', 'leadership_cash_bonus')),
...
-- ============================================
-- MONTHLY SALES SNAPSHOTS
-- Tracks monthly sales per partner for "3 consecutive months" rank qualification
-- ============================================
CREATE TABLE monthly_sales_snapshots (
    id SERIAL PRIMARY KEY,
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
...
CREATE INDEX idx_monthly_snapshots_user ON monthly_sales_snapshots(user_id);
CREATE INDEX idx_monthly_snapshots_period ON monthly_sales_snapshots(year, month);

-- ============================================
-- LEADERSHIP CASH BONUS TRACKING
-- One-time: €500 (Teamleiter), €1000 (Manager), €2000 (Sales Manager) after 3 stable months
-- ============================================
CREATE TABLE leadership_cash_bonuses (
    id SERIAL PRIMARY KEY,
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
...
-- ============================================
-- BONUS POOL: 2% of total company revenue shared among active leaders monthly
-- ============================================
CREATE TABLE bonus_pool_distributions (
    id SERIAL PRIMARY KEY,
    year INTEGER NOT NULL,
    month INTEGER NOT NULL,
...
CREATE TABLE bonus_pool_payouts (
    id SERIAL PRIMARY KEY,
