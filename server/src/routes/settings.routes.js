...
// Compatibility aliases for frontend calls using /settings/* prefix
router.get('/settings/company', settingsController.getCompanySettings);
router.get('/settings/shipping-rules', settingsController.getShippingRules);
router.get('/settings/return-policy', settingsController.getReturnPolicy);
router.get('/settings/shipping-costs', settingsController.getShippingCosts);
router.get('/settings/vat-rates', settingsController.getVatRates);
...
router.put('/settings/admin/company', authenticate, isAdmin, settingsController.updateCompanySettings);

// Admin routes - Shipping rules
router.put('/admin/shipping-rules/:id', authenticate, isAdmin, settingsController.updateShippingRule);
router.put('/settings/admin/shipping-rules/:id', authenticate, isAdmin, settingsController.updateShippingRule);

// Admin routes - Return policy
router.put('/admin/return-policy', authenticate, isAdmin, settingsController.updateReturnPolicy);
router.put('/settings/admin/return-policy', authenticate, isAdmin, settingsController.updateReturnPolicy);

// Admin routes - Shipping costs
router.put('/admin/shipping-costs', authenticate, isAdmin, settingsController.updateShippingCosts);
router.put('/settings/admin/shipping-costs', authenticate, isAdmin, settingsController.updateShippingCosts);

// Admin routes - VAT rates
router.put('/admin/vat-rates', authenticate, isAdmin, settingsController.updateVatRates);
router.put('/settings/admin/vat-rates', authenticate, isAdmin, settingsController.updateVatRates);
