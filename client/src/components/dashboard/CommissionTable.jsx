...
const CommissionTable = ({ commissions = [], isLoading = false, commissionVatInfo = null }) => {
  ...
  const typeLabels = {
    direct: 'Direktprovision',
    difference: 'Differenzprovision',
    admin: 'Admin-Provision',
    leadership_bonus: 'Führungsbonus',
    team_volume_bonus: 'Teambonus',
    ...
    >
      ...
      <div className="p-6 border-b border-secondary-100 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-heading font-semibold text-secondary-700">Letzte Provisionen</h3>
        </div>
            ...
            {commissions.length === 0 ? (
              ...
              commissions.map((commission) => (
                <tr key={commission.id} className="hover:bg-secondary-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-secondary-600">
                    {commission.orderId || commission.order_number || '-'}
                  </td>
