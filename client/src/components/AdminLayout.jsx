...
export default function AdminLayout() {
  ...
  const menuItems = [
    ...
    { path: '/admin/team', icon: Icons.Partners, label: 'Team-Baum' },
    { path: '/admin/customers', icon: Icons.Partners, label: 'Kunden' },
          ...
          <div className="p-3 border-b border-secondary-600 shrink-0">
            <div className="flex items-center justify-between">
              <Link to="/" className="flex items-center gap-2">
                <img src={logoUrl || "/images/clyr-logo.png"} alt="CLYR" className="w-8 h-8 rounded-lg object-contain bg-white p-1" />
      ...
      <div className="lg:ml-64 min-h-screen">
        ...
        <header className="sticky top-0 bg-white border-b border-gray-200 z-30 lg:hidden">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <Link to="/" className="flex items-center gap-2">
              <img src={logoUrl || "/images/clyr-logo.png"} alt="CLYR" className="w-7 h-7 rounded-lg object-contain" />
