...
export const ordersAPI = {
  ...
  repairFinancials: (id, options = {}) =>
    api.post(`/orders/${id}/repair-financials`, {
...
export const referralAPI = {
  verify: (code, userId = null) =>
    api.post('/referral/verify', { code, userId }),
...
export const adminAPI = {
  ...
  // Full MLM Tree
  getFullTree: () =>
    api.get('/admin/full-tree'),

  // All customers (with purchase data)
  getAllCustomers: () =>
...
export const customerPortalAPI = {
  ...
  forgotPassword: (email) =>
    api.post('/customers/forgot-password', { email }),

  resetPassword: (token, newPassword) =>
    api.post('/customers/reset-password', { token, newPassword }),
