...
const AdminInvoicesPage = () => {
  ...
  const handleDownloadPDF = async (invoice) => {
    try {
      ...
      const endpoint = invoice.type === 'customer' 
        ? `/api/orders/${invoice.order_id}/invoice`
        : `/api/commissions/statement/${invoice.partner_id}`;
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Verwalten Sie Kundenrechnungen und Provisionsabrechnungen
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-gray-600">Provisionsabrechnungen</p>
              <p className="text-lg font-semibold text-gray-900">
                3 Typen verfügbar
              </p>
            </div>
          ...
          <p className="text-xs text-gray-500 mt-2">
            DE: +19% | AT+UID: RC | AT Kleinunternehmer: §6
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          ...
          <p className="text-xs text-gray-500 mt-2">
            Provisionen: FreshLiving - Theresa Struger
          </p>
        </div>
      </div>
