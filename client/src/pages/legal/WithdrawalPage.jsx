        ...
        >
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-8 mb-6">
            ...
            <div className="p-4 bg-gray-50 rounded-xl">
              <p className="font-semibold text-secondary-700">{legal?.companyName || companyName || 'CLYR Solutions GmbH'}</p>
              <p className="text-secondary-700">{legal?.street || 'Pappelweg 4b'}</p>
              <p className="text-secondary-700">{legal?.zip || '1010'} {legal?.city || 'Wien'}</p>
              <p className="text-secondary-700 mt-2">E-Mail: {company?.email || 'service@clyr.shop'}</p>
            </div>
          </div>
