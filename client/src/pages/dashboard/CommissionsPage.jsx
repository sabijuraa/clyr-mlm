          ...
          <Button 
            ...
            onClick={async () => {
              try {
                ...
                const res = await fetch(`/api/commissions/statement/${period}`, {
                ...
                if (res.ok) {
                  ...
                  a.href = url;
                  a.download = `Provisionsgutschrift-${period}.pdf`;
                  document.body.appendChild(a);
                  a.click();
                  a.remove();
                } else {
                  const err = await res.json().catch(() => ({}));
                  alert(err.error || 'Keine Provisionen fuer diesen Zeitraum');
                }
              } catch (err) {
