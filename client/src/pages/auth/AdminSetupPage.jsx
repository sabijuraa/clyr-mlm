    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Überprüfe Setup-Status...</p>
        </div>
      </div>
    );
  }

  // Setup not available (admin already exists)
  if (!setupAvailable) {
    return (
      ...
      <div className="grid lg:grid-cols-2 gap-8 max-w-5xl w-full">
        ...
        >
          ...
          <div className="space-y-4">
            {[
              ...
              { icon: User, text: 'Partner und Kunden verwalten' },
              { icon: Shield, text: 'Sicherheitseinstellungen konfigurieren' },
            ].map((item, idx) => (
        ...
        >
          ...
          <div className="lg:hidden mb-6 text-center">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-teal-500/30">
