    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <button
          ...
          className="lg:hidden mb-4 w-full flex items-center justify-between px-4 py-3 bg-white border border-gray-200 rounded-xl text-sm font-medium text-secondary-700 shadow-sm"
        >
          <span className="flex items-center gap-2">
            <SlidersHorizontal className="w-4 h-4 text-primary-500" />
            {lang === 'de' ? 'Filter & Kategorien' : 'Filters & Categories'}
          </span>
          <ChevronRight className={`w-4 h-4 transition-transform ${mobileFiltersOpen ? 'rotate-90' : ''}`} />
        </button>

        <div className="lg:grid lg:grid-cols-4 lg:gap-8">

          {/* Sidebar - Categories & Filters */}
          <aside className={`lg:col-span-1 mb-6 lg:mb-0 ${mobileFiltersOpen ? 'block' : 'hidden lg:block'}`}>
