          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-500 mt-1">
                {itemCount} {itemCount === 1 ? 'Artikel' : 'Artikel'} {lang === 'de' ? 'in Ihrem Warenkorb' : 'in your cart'}
              </p>
            </div>
            {!isEmpty && (
              <button
                onClick={clearCart}
                className="flex items-center gap-2 px-4 py-2 text-gray-500 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all"
              >
        ...
        {isEmpty ? (
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-4">
              ...
              <Link
                to="/produkte"
                className="inline-flex items-center gap-2 text-teal-600 hover:text-teal-700 font-medium mt-6"
              >
                <ArrowLeft className="w-4 h-4" />
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6 sticky top-24">
                ...
                <div className="mt-6 p-4 bg-teal-50 rounded-xl border border-teal-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-teal-800">{lang === 'de' ? 'Sicher einkaufen' : 'Secure Shopping'}</p>
                      <p className="text-sm text-teal-600">{lang === 'de' ? 'SSL-verschlüsselt' : 'SSL encrypted'}</p>
                    </div>
                  </div>
                </div>
              </div>
